...
export const GroceryList: React.FC = () => {
  ...
  const handleExportPdf = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `grocery-list-${new Date().toISOString().split("T")[0]}.pdf`;
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center gap-1.5 text-xs font-semibold text-slate-500 bg-white border border-slate-200 px-3 py-2 rounded-lg hover:bg-slate-50 transition-colors disabled:opacity-50"
          >
            <RefreshCw
