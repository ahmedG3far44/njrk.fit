                  ...
                  <div className="flex gap-0.5 mt-1">
                    {Array(7)
                      ...
                      .map((_, i) => (
                        <div
                          key={i}
                          className={`h-1.5 rounded-full flex-1 ${i < 0 ? "bg-orange-500" : "bg-slate-200"}`}
                        />
                      ))}
                  </div>
                </div>
              ...
              <motion.div
                ...
                style={
                  plan.isBest
                    ? {
                        boxShadow:
                          "0 0 0 2px #166534, 0 25px 50px -12px rgba(22,101,52,0.45)",
                      }
                    : {}
                }
              >
                ...
                <ul className="space-y-4 mb-8">
                  {plan.features.map((item) => (
                    ...
                    >
                      ...
                      >
                        <Check
                          className={`w-3 h-3 ${plan.isBest ? "text-white" : "text-green-600"}`}
                        />
                      </div>{" "}
                      {item}
                    </li>
