            ...
            {streakData.currentStreak > 0 ? (
              <>
                ...
                <span className="inline-flex items-center gap-1 text-orange-500 font-bold">
                  <Flame className="w-3.5 h-3.5" /> {streakData.currentStreak}-day
                  streak
                </span>
                . Keep it up!
              </>
          ...
          <div className="relative z-10 flex items-center gap-3.5 sm:gap-4">
            ...
            <div>
              <div className="flex items-baseline gap-1.5 sm:gap-2 mb-0.5">
                ...
                <span className="font-bold text-slate-600 text-xs sm:text-base">Day Streak</span>
              </div>
        ...
        <div className="flex items-center justify-between mb-4 sm:mb-5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-xs text-slate-400">Daily macros progress</p>
            </div>
          </div>
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-300 group-hover:text-green-600 transition-colors" />
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 p-4 sm:p-5 text-white">
            ...
            <h3 className="font-bold text-sm sm:text-base">Step Challenge</h3>
        ...
        >
          <div>
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              ...
              <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-200 group-hover:text-green-600 transition-colors" />
            </div>
            <h3 className="font-bold text-sm sm:text-base text-slate-900 mb-1">Shopping List</h3>
          ...
          <div className="relative z-10 w-full h-full flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-2.5 sm:mb-3">
                ...
                <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white/50 group-hover:text-white transition-colors" />
              </div>
