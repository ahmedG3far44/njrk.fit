...
const envSchema = z.object({
  ...
  LLM_MODEL: z.string().default("google/gemma-2-9b-it:free"),
  LLM_MODEL_AR: z.string().default("qwen/qwen-2.5-72b-instruct"),
  LLM_MODEL_EN: z.string().default("meta-llama/llama-3.3-70b-instruct"),
  LLM_PROVIDER: z.string().default("openrouter"),
  GEMINI_API_KEY: z.string().default(""),
  GEMINI_MODEL_EN: z.string().default("gemini-2.5-flash"),
  GEMINI_MODEL_AR: z.string().default("gemini-2.5-flash"),
  OPENAI_API_KEY: z.string().default(""),
  OPENAI_MODEL_EN: z.string().default("gpt-4o-mini"),
  OPENAI_MODEL_AR: z.string().default("gpt-4o-mini"),
