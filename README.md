...
| `JWT_ADMIN_EXPIRATION`         | No       | Admin Access token expiry (default `3h`)  |
| `JWT_ADMIN_REFRESH_EXPIRATION` | No       | Admin Refresh token expiry (default `7d`) |
| `STRIPE_SECRET_KEY`            | **Yes**  | Stripe secret key                         |
| `STRIPE_WEBHOOK_SECRET`        | **Yes**  | Stripe webhook signing secret             |
| `PRO_PRICE_ID`                 | **Yes**  | Pro plan price ID                         |
| `FAMILY_PRICE_ID`              | **Yes**  | Family plan price ID                      |
...
| `VITE_PRO_PRICE_ID`    | **Yes**  | Stripe Pro price ID for checkout                         |
| `VITE_FAMILY_PRICE_ID` | **Yes**  | Stripe Family price ID for checkout                      |
